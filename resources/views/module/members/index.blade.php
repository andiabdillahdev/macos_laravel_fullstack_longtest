...
@section('button')
    <button class="btn btn-primary btn-sm " data-kt-drawer-show="true" data-kt-drawer-target="#side_form" id="button-side-form"><i class="fa fa-plus-circle" style="color:#ffffff" aria-hidden="true"></i> Tambah Data Anggota</button>
@endsection
@section('content')
        ...
        <div class="card-body hover-scroll-overlay-y">
           <form class="form-data">
                ...
                <div class="mb-10">
                    ...
                    <input type="text" id="nama" class="form-control" name="name" placeholder="Masukkan nama">
                    <small class="text-danger name_error"></small>
                </div>

                <div class="mb-10">
                    <label class="form-label">Alamat</label>
                    <input type="text" id="alamat" class="form-control" name="address" placeholder="Masukkan alamat">
                ...
                <div class="mb-10">
                    ...
                    <input type="text" id="phone_number" class="form-control" name="phone_number" placeholder="Masukkan Nomor telepon">
                    <small class="text-danger phone_number_error"></small>
                </div>

                <div class="mb-10">
                    <label class="form-label">Tanggal lahir</label>
                    <input type="date" id="tanggal_lahir" class="form-control" name="date_of_birth" placeholder="Masukkan Tanggal lahir">
...
<script>
    ...
    $(document).on('submit', ".form-data", function(e){
        ...
        if (type == 'add') {
            control.submitForm('/members/store','Tambah','Anggota','POST');
        }else{
            let id = $("input[name='id']").val();
            control.submitForm('/members/update/'+id,'Update','Anggota', 'PUT');
        }
    });
    ...
    $(document).on('click','.button-update', function (e) {
       ...
       $(document).on('click','.btn-delete', function (e) {
        e.preventDefault();
        let url = '/members/delete/'+$(this).attr('data-id');
    ...
    $(function () {
        ...
        control.initDatatable('/members/datatable-list',columns,columnDefs);
    })
</script>
@endsection